 ...
 * @author wangyanlai
 */
public class PerTrainingIntegration {
    /**
     * 培训班id
     */
    private String id;
    ...
    /**
     * 是否结业（0未结业，1已结业）
     * @return IF_GRADUATION 是否结业（0未结业，1已结业）
     */
    public String getIfGraduation() {
        return ifGraduation;
    }

    /**
     * 是否结业（0未结业，1已结业）
     * @param ifGraduation 是否结业（0未结业，1已结业）
     */
    public void setIfGraduation(String ifGraduation) {
        this.ifGraduation = ifGraduation == null ? null : ifGraduation.trim();
    }
