 ...
 * @author wangyanlai
 */
public class PerExchangeIntegration {
    /**
     * 兑换id
     */
    private String id;
    ...
    /**
     * 兑换金额
     * @param exchangeScore 兑换金额
     */
    public void setExchangeScore(String exchangeScore) {
        this.exchangeScore = exchangeScore == null ? null : exchangeScore.trim();
    }
